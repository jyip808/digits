      ...
      <div className="cat">
        <Grid container columns={3} stackable centered>
          ...
          <Grid.Column textAlign='center'>
            ...
            <Header as="h3" inverted>This address book enables any number of users to register ans save their business contacts. You can only see the contacts you have created.</Header>
          </Grid.Column>
          ...
          <Grid.Column textAlign='center'>
            ...
            <Header as="h3" inverted>Each time you can make contact with a contact, you can write a note that summarizes the conversation. This note is saved along with a timestamp with the contact.</Header>
          </Grid.Column>
        </Grid>
      </div>
    );
